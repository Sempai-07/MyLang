    ...
    if (options) {
        if ((0, utils_1.isFunctionNode)(options) && !callback) {
            const callCallback = (...args) => options.evaluate(options.parentEnv).call([
                ...
                {
                    value: typeof args[1] === "string" ? args[1] : (0, index_1.BufferWrapper)([args[1]]),
                },
                {
                    value: typeof args[2] === "string" ? args[2] : (0, index_1.BufferWrapper)([args[2]]),
                },
            ]);
...
function execSync(args) {
    ...
    return typeof result === "string" ? result : (0, index_1.BufferWrapper)([result]);
}
